...
(()=>{
  ...
  parityCoreMarkup=function composedMasonry(){
    ...
    return sites.map(site=>{
      ...
      if(spatial){
        // Deliberate desktop lanes survive content-height changes. Collapsed
        // lanes retain lane-major reading/focus order across 3/2/1 columns.
        ...
        // Exact UI48 packing remains the migration/read-only fallback.
