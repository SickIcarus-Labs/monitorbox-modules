...
<div class="grid"><section class="card"><h2>Config doctor</h2><div id="doctor" class="status">Not run yet.</div></section><section class="card"><h2>Retained revisions</h2><p class="muted">A retained revision restores configuration only. MonitorBox validates the selected snapshot against current protected material and commits it as a <strong>new</strong> canonical revision; revision history is never rewound.</p><div id="revisionState" class="status">No retained revision restore requested.</div><div id="revisions" style="margin-top:8px" class="muted">Loading…</div></section></div>
