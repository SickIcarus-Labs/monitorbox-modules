...
const aggregateSource = fs.readFileSync(
  new URL("../sources/ui/1.3.2-build37/aggregate-evidence.js", import.meta.url),
  "utf8",
);
...
const networkSource = fs.readFileSync(
  new URL("../sources/ui/1.3.2-build37/network-children.js", import.meta.url),
  "utf8",
);
...
console.log("UI build37 provider-blind aggregate fixtures: PASS");
