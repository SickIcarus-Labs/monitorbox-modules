...
def main() -> None:
    ...
    editor=package[NEW + "assets/card-layout-editor.html"]
    assert editor.count(b"v=1.11.0-47")==5
    assert b"v=1.8.0-44" not in editor
    assert b"grid-auto-flow:row" in package[NEW + "assets/card-composer.css"]
