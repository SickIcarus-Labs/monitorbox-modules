...
PREDECESSOR = ("com.sickicarus.monitorbox.ui", "1.3.0", 34)
RELEASE = ("com.sickicarus.monitorbox.ui", "1.3.1", 35)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b35:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.3.1-build35.zip",
}
