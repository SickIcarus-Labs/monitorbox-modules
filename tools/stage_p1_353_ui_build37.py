...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.3.2", 37)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b37:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.3.2-build37.zip",
}
...
def stage(path: Path) -> bool:
    ...
    if matches:
        if len(matches) != 1 or matches[0] != ENTRY:
            raise SystemExit("UI build37 catalog conflict")
        return False
