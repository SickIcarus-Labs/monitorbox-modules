...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.2.0", 32)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b32:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.2.0-build32.zip",
}
...
def stage(path: Path) -> bool:
    ...
    if matches:
        if len(matches) != 1 or matches[0] != ENTRY:
            raise SystemExit("UI build32 catalog conflict")
        return False
