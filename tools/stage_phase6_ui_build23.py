#!/usr/bin/env python3
"""Idempotently stage the Phase-6A replacement UI 1.1.13 build-23 candidate."""
from __future__ import annotations
import json
from pathlib import Path
from typing import Any

# Builds 21/22 were signed dev candidates but never entered trunk catalog.
# Preserve their source/history and publish build23 after the last accepted UI.
PREDECESSOR=("com.sickicarus.monitorbox.ui","1.1.12",20)
RELEASE=("com.sickicarus.monitorbox.ui","1.1.13",23)
ENTRY={
  "manifest":{
    ...
    "state_schema":1,
    "module_type":"ui",
    "entrypoints":{"webui":"monitorbox_ui_b23:install"},
  ...
  "package":"com.sickicarus.monitorbox.ui-1.1.13-build23.zip"
}
...
def stage(path:Path)->bool:
    ...
    print("staged Phase-6A replacement UI 1.1.13 build 23 after accepted build 20")
    return True
