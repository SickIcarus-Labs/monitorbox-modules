...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.3.2", 36)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b36:install"},
        "requires_core": ">=2.5.2 <3.0.0",
    ...
    "package": "com.sickicarus.monitorbox.ui-1.3.2-build36.zip",
}
