#!/usr/bin/env python3
"""UI47: actual Chromium verifies one existing live fetch carries bounded card interests."""
...
import build_first_party_ui_build47 as ui
    ...
    async with async_playwright() as pw:
        ...
        try:
            for width, height in ((820, 1100), (1366, 900)):
                ...
                await ctx.close()
                print(
                    f"UI47 {width}x{height}: single 1Hz request, two distinct "
