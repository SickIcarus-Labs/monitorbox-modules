#!/usr/bin/env node
// UI46 #94: live public telemetry and inline renderer remain display-only.
import assert from 'node:assert/strict';
import fs from 'node:fs';
import vm from 'node:vm';

const base=new URL('../sources/ui/1.10.0-build46/',import.meta.url);
...
console.log('UI46: site-scoped 1 Hz gauge/rate, link-vs-scale basis, network status migration, fresh/stale/missing and inline rendering: PASS');
