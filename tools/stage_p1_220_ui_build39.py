#!/usr/bin/env python3
"""Stage isolated UI build39 from accepted build35 only; no 36-38 lineage."""
...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.4.0", 39)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b39:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.4.0-build39.zip",
}
...
def stage(path: Path) -> bool:
    ...
    if matches:
        if len(matches) != 1 or matches[0] != ENTRY:
            raise SystemExit("UI build39 catalog conflict")
        return False
    ...
    print("staged isolated UI 1.4.0 build39")
    return True
