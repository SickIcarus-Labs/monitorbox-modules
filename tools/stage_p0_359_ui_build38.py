...
PREDECESSOR = ("com.sickicarus.monitorbox.ui", "1.3.2", 37)
RELEASE = ("com.sickicarus.monitorbox.ui", "1.4.0", 38)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b38:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.4.0-build38.zip",
}
