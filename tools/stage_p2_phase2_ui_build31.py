...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.1.18", 31)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b31:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.1.18-build31.zip",
}
...
def stage(path: Path) -> bool:
    ...
    if matches:
        if len(matches) != 1 or matches[0] != ENTRY:
            raise SystemExit("UI build 31 catalog conflict")
        return False
    ...
    print("staged UI 1.1.18 build 31")
    return True
