#!/usr/bin/env python3
"""Idempotently stage P2 Phase-2 physical-correction UI v1.1.16 build 29."""
...
ENTRY={
  "manifest":{
    ...
    "version":"1.1.16",
    "build":29,
    "schema":1,"state_schema":1,"module_type":"ui",
    "entrypoints":{"webui":"monitorbox_ui_b29:install"},
    "requires_core":">=2.3.1 <3.0.0","requires_runtime_api":">=1 <2",
    "dependencies":[],"publisher_id":"com.sickicarus","permissions":[],
    "lifecycle_policy":"required"
  },
  "package":"com.sickicarus.monitorbox.ui-1.1.16-build29.zip"
}
