...
PREDECESSOR = ("com.sickicarus.monitorbox.ui", "1.2.1", 33)
RELEASE = ("com.sickicarus.monitorbox.ui", "1.3.0", 34)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b34:install"},
        "requires_core": ">=2.4.1 <3.0.0",
    ...
    "package": "com.sickicarus.monitorbox.ui-1.3.0-build34.zip",
}
