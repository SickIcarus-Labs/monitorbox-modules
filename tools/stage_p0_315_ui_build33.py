...
RELEASE = ("com.sickicarus.monitorbox.ui", "1.2.1", 33)
...
ENTRY = {
    "manifest": {
        ...
        "state_schema": 1,
        "module_type": "ui",
        "entrypoints": {"webui": "monitorbox_ui_b33:install"},
    ...
    "package": "com.sickicarus.monitorbox.ui-1.2.1-build33.zip",
}
...
def stage(path: Path) -> bool:
    ...
    if matches:
        if len(matches) != 1 or matches[0] != ENTRY:
            raise SystemExit("UI build33 catalog conflict")
        return False
