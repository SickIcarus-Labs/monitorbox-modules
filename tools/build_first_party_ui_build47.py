...
def _package_files(root: Path) -> dict[str, bytes]:
    ...
    # The original live script was unversioned. Force the browser to fetch
    # this UI47 viewer-interest implementation instead of its cached UI46 copy.
    html = parent["assets/dashboard.html"]
    needle = b'/static/live-telemetry.js" defer'
    if html.count(needle) != 1:
        raise SystemExit("UI47 expected one unversioned parent live script")
    html = html.replace(needle, b'/static/live-telemetry.js?v=' + UI_GENERATION.encode() + b'" defer')
